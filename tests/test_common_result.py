...
from agile.web.common_result import StatusWritableResponse, R
...
class TestCommonResult(unittest.TestCase):
    ...
    def test_success_with_custom_values(self):
    ...
    def test_set_http_status_writes_response(self):
        r = R.success()
        resp = DummyResponse()
    ...
    def test_set_http_status_without_value_keeps_existing(self):
    ...
    def test_extract_data_default_on_failure(self):
